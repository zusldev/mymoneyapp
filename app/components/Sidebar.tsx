...
export function Sidebar() {
    ...
    return (
        <aside className="hidden md:flex w-20 lg:w-64 bg-white dark:bg-[#1a262d] border-r border-slate-200 dark:border-slate-800 flex-col justify-between transition-all duration-300 z-20">
            <div>
                {/* Logo */}
